...
class QNetworkCacheMetaData(sip.simplewrapper):
    ...
    def setRawHeaders(self, headers: typing.Iterable[typing.Tuple[
        typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Union[
            QtCore.QByteArray, bytes, bytearray]]]) -> None: ...
...
class QAbstractSocket(QtCore.QIODevice):
    ...
    @typing.overload
    def bind(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], port: int = ...,
             mode: typing.Union['QAbstractSocket.BindMode', 'QAbstractSocket.BindFlag'] = ...) -> bool: ...
    ...
    def setPauseMode(self,
                     pauseMode: typing.Union['QAbstractSocket.PauseModes', 'QAbstractSocket.PauseMode']) -> None: ...
    ...
    def setSocketDescriptor(self, socketDescriptor: sip.voidptr, state: 'QAbstractSocket.SocketState' = ...,
                            mode: typing.Union[
                                QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> bool: ...
    ...
    def connectToHost(self, hostName: str, port: int,
                      ...
                      protocol: 'QAbstractSocket.NetworkLayerProtocol' = ...) -> None: ...

    @typing.overload
    def connectToHost(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], port: int,
                      mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> None: ...
...
class QDnsLookup(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, type: 'QDnsLookup.Type', name: str,
...
class QHostAddress(sip.simplewrapper):
    ...
    class ConversionMode(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QHostAddress.ConversionMode', 'QHostAddress.ConversionModeFlag']) -> None: ...
    ...
    @typing.overload
    def __init__(self, ip6Addr: typing.Tuple[
        int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]) -> None: ...
    ...
    def isEqual(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'],
                mode: typing.Union['QHostAddress.ConversionMode', 'QHostAddress.ConversionModeFlag'] = ...) -> bool: ...
    ...
    @typing.overload
    def isInSubnet(self,
                   subnet: typing.Tuple[typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], int]) -> bool: ...
    ...
    def toIPv6Address(self) -> typing.Tuple[
    ...
    @typing.overload
    def setAddress(self, ip6Addr: typing.Tuple[
        int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]) -> None: ...
...
class QHostInfo(sip.simplewrapper):
    ...
    def setAddresses(self,
                     addresses: typing.Iterable[typing.Union[QHostAddress, QHostAddress.SpecialAddress]]) -> None: ...
...
class QHstsPolicy(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, expiry: typing.Union[QtCore.QDateTime, datetime.datetime],
                 flags: typing.Union['QHstsPolicy.PolicyFlags', 'QHstsPolicy.PolicyFlag'], host: str,
                 mode: QtCore.QUrl.ParsingMode = ...) -> None: ...
    ...
    def host(self, options: typing.Union[
        QtCore.QUrl.ComponentFormattingOptions, QtCore.QUrl.ComponentFormattingOption] = ...) -> str: ...
...
class QHttpPart(sip.simplewrapper):
    ...
    def setRawHeader(self, headerName: typing.Union[QtCore.QByteArray, bytes, bytearray],
                     headerValue: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...
...
class QHttpMultiPart(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, contentType: 'QHttpMultiPart.ContentType',
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QLocalServer(QtCore.QObject):
    ...
    def setSocketOptions(self,
                         options: typing.Union['QLocalServer.SocketOptions', 'QLocalServer.SocketOption']) -> None: ...
...
class QLocalSocket(QtCore.QIODevice):
    ...
    def setSocketDescriptor(self, socketDescriptor: sip.voidptr, state: 'QLocalSocket.LocalSocketState' = ...,
                            mode: typing.Union[
                                QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> bool: ...
    ...
    @typing.overload
    def connectToServer(self, name: str,
                        mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> None: ...
...
class QNetworkAccessManager(QtCore.QObject):
    ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int = ...,
                               sslConfiguration: 'QSslConfiguration' = ...) -> None: ...
    ...
    @typing.overload
    def sendCustomRequest(self, request: 'QNetworkRequest', verb: typing.Union[QtCore.QByteArray, bytes, bytearray],
                          data: typing.Optional[QtCore.QIODevice] = ...) -> 'QNetworkReply': ...

    @typing.overload
    def sendCustomRequest(self, request: 'QNetworkRequest', verb: typing.Union[QtCore.QByteArray, bytes, bytearray],
                          data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> 'QNetworkReply': ...

    @typing.overload
    def sendCustomRequest(self, request: 'QNetworkRequest', verb: typing.Union[QtCore.QByteArray, bytes, bytearray],
                          multiPart: QHttpMultiPart) -> 'QNetworkReply': ...
    ...
    def createRequest(self, op: 'QNetworkAccessManager.Operation', request: 'QNetworkRequest',
                      device: typing.Optional[QtCore.QIODevice] = ...) -> 'QNetworkReply': ...

    def preSharedKeyAuthenticationRequired(self, reply: 'QNetworkReply',
                                           authenticator: 'QSslPreSharedKeyAuthenticator') -> None: ...
    ...
    @typing.overload
    def put(self, request: 'QNetworkRequest',
            data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> 'QNetworkReply': ...  # type: ignore
    ...
    @typing.overload
    def post(self, request: 'QNetworkRequest',
             data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> 'QNetworkReply': ...  # type: ignore
...
class QNetworkConfigurationManager(QtCore.QObject):
    ...
    class Capabilities(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QNetworkConfigurationManager.Capabilities', 'QNetworkConfigurationManager.Capability']) -> None: ...
    ...
    def allConfigurations(self, flags: typing.Union[
        'QNetworkConfiguration.StateFlags', 'QNetworkConfiguration.StateFlag'] = ...) -> typing.List[
...
class QNetworkConfiguration(sip.simplewrapper):
    ...
    class StateFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QNetworkConfiguration.StateFlags', 'QNetworkConfiguration.StateFlag']) -> None: ...
...
class QNetworkCookie(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...,
                 value: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...
    ...
    @staticmethod
    def parseCookies(cookieString: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> typing.List[
        'QNetworkCookie']: ...
...
class QNetworkDatagram(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, data: typing.Union[QtCore.QByteArray, bytes, bytearray],
                 destinationAddress: typing.Union[QHostAddress, QHostAddress.SpecialAddress] = ...,
                 port: int = ...) -> None: ...
...
class QNetworkInterface(sip.simplewrapper):
    ...
    class InterfaceFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QNetworkInterface.InterfaceFlags', 'QNetworkInterface.InterfaceFlag']) -> None: ...
...
class QNetworkProxy(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, type: 'QNetworkProxy.ProxyType', hostName: str = ..., port: int = ..., user: str = ...,
                 password: str = ...) -> None: ...
    ...
    def setCapabilities(self,
                        capab: typing.Union['QNetworkProxy.Capabilities', 'QNetworkProxy.Capability']) -> None: ...
...
class QNetworkProxyQuery(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, hostname: str, port: int, protocolTag: str = ...,
                 type: 'QNetworkProxyQuery.QueryType' = ...) -> None: ...

    @typing.overload
    def __init__(self, bindPort: int, protocolTag: str = ..., type: 'QNetworkProxyQuery.QueryType' = ...) -> None: ...

    @typing.overload
    def __init__(self, networkConfiguration: QNetworkConfiguration, requestUrl: QtCore.QUrl,
                 queryType: 'QNetworkProxyQuery.QueryType' = ...) -> None: ...

    @typing.overload
    def __init__(self, networkConfiguration: QNetworkConfiguration, hostname: str, port: int, protocolTag: str = ...,
                 type: 'QNetworkProxyQuery.QueryType' = ...) -> None: ...

    @typing.overload
    def __init__(self, networkConfiguration: QNetworkConfiguration, bindPort: int, protocolTag: str = ...,
                 type: 'QNetworkProxyQuery.QueryType' = ...) -> None: ...
...
class QNetworkSession(QtCore.QObject):
    ...
    def usagePoliciesChanged(self, usagePolicies: typing.Union[
        'QNetworkSession.UsagePolicies', 'QNetworkSession.UsagePolicy']) -> None: ...
...
class QPasswordDigestor(sip.simplewrapper):
    ...
    def deriveKeyPbkdf2(self, algorithm: QtCore.QCryptographicHash.Algorithm,
                        password: typing.Union[QtCore.QByteArray, bytes, bytearray],
                        salt: typing.Union[QtCore.QByteArray, bytes, bytearray], iterations: int,
                        dkLen: int) -> QtCore.QByteArray: ...

    def deriveKeyPbkdf1(self, algorithm: QtCore.QCryptographicHash.Algorithm,
                        password: typing.Union[QtCore.QByteArray, bytes, bytearray],
                        salt: typing.Union[QtCore.QByteArray, bytes, bytearray], iterations: int,
                        dkLen: int) -> QtCore.QByteArray: ...
...
class QSslCertificate(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, data: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...,
                 format: QSsl.EncodingFormat = ...) -> None: ...
    ...
    @staticmethod
    def importPkcs12(device: QtCore.QIODevice, key: 'QSslKey', certificate: 'QSslCertificate',
                     caCertificates: typing.Optional[typing.Iterable['QSslCertificate']] = ...,
                     passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> bool: ...
    ...
    @staticmethod
    def verify(certificateChain: typing.Iterable['QSslCertificate'], hostName: str = ...) -> typing.List[
        'QSslError']: ...
    ...
    @staticmethod
    def fromData(data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: QSsl.EncodingFormat = ...) -> \
    ...
    @staticmethod
    def fromPath(path: str, format: QSsl.EncodingFormat = ..., syntax: QtCore.QRegExp.PatternSyntax = ...) -> \
    typing.List['QSslCertificate']: ...
...
class QSslConfiguration(sip.simplewrapper):
    ...
    def setBackendConfiguration(self, backendConfiguration: typing.Dict[
        typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Any] = ...) -> None: ...

    def setBackendConfigurationOption(self, name: typing.Union[QtCore.QByteArray, bytes, bytearray],
    ...
    def setAllowedNextProtocols(self, protocols: typing.Iterable[
        typing.Union[QtCore.QByteArray, bytes, bytearray]]) -> None: ...
...
class QSslDiffieHellmanParameters(sip.simplewrapper):
    ...
    @typing.overload
    @staticmethod
    def fromEncoded(encoded: typing.Union[QtCore.QByteArray, bytes, bytearray],
                    encoding: QSsl.EncodingFormat = ...) -> 'QSslDiffieHellmanParameters': ...
...
class QSslKey(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, encoded: typing.Union[QtCore.QByteArray, bytes, bytearray], algorithm: QSsl.KeyAlgorithm,
                 encoding: QSsl.EncodingFormat = ..., type: QSsl.KeyType = ...,
                 passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...

    @typing.overload
    def __init__(self, device: QtCore.QIODevice, algorithm: QSsl.KeyAlgorithm, encoding: QSsl.EncodingFormat = ...,
                 type: QSsl.KeyType = ...,
                 passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...
...
class QSslSocket(QTcpSocket):
    ...
    def connectToHost(self, hostName: str, port: int,
                      mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...,
                      protocol: QAbstractSocket.NetworkLayerProtocol = ...) -> None: ...  # type: ignore
    ...
    @typing.overload
    @staticmethod
    def addDefaultCaCertificates(path: str, format: QSsl.EncodingFormat = ...,
                                 syntax: QtCore.QRegExp.PatternSyntax = ...) -> bool: ...
    ...
    @typing.overload
    def addCaCertificates(self, path: str, format: QSsl.EncodingFormat = ...,
                          syntax: QtCore.QRegExp.PatternSyntax = ...) -> bool: ...
    ...
    @typing.overload
    def setPrivateKey(self, fileName: str, algorithm: QSsl.KeyAlgorithm = ..., format: QSsl.EncodingFormat = ...,
                      passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...
    ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int, sslPeerName: str,
                               mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...,
                               protocol: QAbstractSocket.NetworkLayerProtocol = ...) -> None: ...
...
class QTcpServer(QtCore.QObject):
    ...
    def listen(self, address: typing.Union[QHostAddress, QHostAddress.SpecialAddress] = ...,
               port: int = ...) -> bool: ...
...
class QUdpSocket(QAbstractSocket):
    ...
    @typing.overload
    def leaveMulticastGroup(self, groupAddress: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
                            iface: QNetworkInterface) -> bool: ...

    @typing.overload
    def joinMulticastGroup(self, groupAddress: typing.Union[QHostAddress, QHostAddress.SpecialAddress]) -> bool: ...

    @typing.overload
    def joinMulticastGroup(self, groupAddress: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
                           iface: QNetworkInterface) -> bool: ...

    @typing.overload
    def writeDatagram(self, data: bytes, host: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
                      port: int) -> int: ...

    @typing.overload
    def writeDatagram(self, datagram: typing.Union[QtCore.QByteArray, bytes, bytearray],
                      host: typing.Union[QHostAddress, QHostAddress.SpecialAddress], port: int) -> int: ...
