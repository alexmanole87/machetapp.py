...
class QObject(sip.wrapper):
    ...
    @typing.overload
    def findChildren(self, type: type, name: str = ...,
                     options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> typing.List[
        'QObject']: ...
    ...
    @typing.overload
    def findChildren(self, type: type, regExp: 'QRegExp',
                     options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> typing.List[
        'QObject']: ...

    @typing.overload
    def findChildren(self, types: typing.Tuple, regExp: 'QRegExp',
                     options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> typing.List[
        'QObject']: ...
    ...
    @typing.overload
    def findChildren(self, types: typing.Tuple, re: 'QRegularExpression',
                     options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> typing.List[
        'QObject']: ...

    @typing.overload
    def findChild(self, type: type, name: str = ...,
                  options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> 'QObject': ...

    @typing.overload
    def findChild(self, types: typing.Tuple, name: str = ...,
                  options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> 'QObject': ...
...
class QAbstractEventDispatcher(QObject):
    ...
    def filterNativeEvent(self, eventType: typing.Union['QByteArray', bytes, bytearray], message: sip.voidptr) -> \
    ...
    def processEvents(self,
                      flags: typing.Union['QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag']) -> bool: ...
...
class QAbstractItemModel(QObject):
    ...
    class CheckIndexOptions(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QAbstractItemModel.CheckIndexOptions', 'QAbstractItemModel.CheckIndexOption']) -> None: ...
    ...
    def checkIndex(self, index: QModelIndex, options: typing.Union[
        'QAbstractItemModel.CheckIndexOptions', 'QAbstractItemModel.CheckIndexOption'] = ...) -> bool: ...

    def moveColumn(self, sourceParent: QModelIndex, sourceColumn: int, destinationParent: QModelIndex,
                   destinationChild: int) -> bool: ...

    def moveRow(self, sourceParent: QModelIndex, sourceRow: int, destinationParent: QModelIndex,
                destinationChild: int) -> bool: ...

    def moveColumns(self, sourceParent: QModelIndex, sourceColumn: int, count: int, destinationParent: QModelIndex,
                    destinationChild: int) -> bool: ...
    ...
    def beginMoveColumns(self, sourceParent: QModelIndex, sourceFirst: int, sourceLast: int,
                         destinationParent: QModelIndex, destinationColumn: int) -> bool: ...

    def endMoveRows(self) -> None: ...

    def beginMoveRows(self, sourceParent: QModelIndex, sourceFirst: int, sourceLast: int,
                      destinationParent: QModelIndex, destinationRow: int) -> bool: ...

    def columnsMoved(self, parent: QModelIndex, start: int, end: int, destination: QModelIndex,
                     column: int) -> None: ...

    def columnsAboutToBeMoved(self, sourceParent: QModelIndex, sourceStart: int, sourceEnd: int,
                              destinationParent: QModelIndex, destinationColumn: int) -> None: ...

    def rowsMoved(self, parent: QModelIndex, start: int, end: int, destination: QModelIndex, row: int) -> None: ...

    def rowsAboutToBeMoved(self, sourceParent: QModelIndex, sourceStart: int, sourceEnd: int,
                           destinationParent: QModelIndex, destinationRow: int) -> None: ...
    ...
    def changePersistentIndexList(self, from_: typing.Iterable[QModelIndex],
                                  to: typing.Iterable[QModelIndex]) -> None: ...
    ...
    def layoutChanged(self, parents: typing.Iterable[QPersistentModelIndex] = ...,
                      hint: 'QAbstractItemModel.LayoutChangeHint' = ...) -> None: ...

    def layoutAboutToBeChanged(self, parents: typing.Iterable[QPersistentModelIndex] = ...,
                               hint: 'QAbstractItemModel.LayoutChangeHint' = ...) -> None: ...
...
class QAbstractTableModel(QAbstractItemModel):
    ...
    def parent(self) -> QObject: ...  # type: ignore
...
class QAbstractNativeEventFilter(sip.simplewrapper):
    ...
    def nativeEventFilter(self, eventType: typing.Union['QByteArray', bytes, bytearray], message: sip.voidptr) -> \
    typing.Tuple[bool, int]: ...
...
class QByteArray(sip.simplewrapper):
    ...
    @staticmethod
    def fromPercentEncoding(input: typing.Union['QByteArray', bytes, bytearray],
                            percent: str = ...) -> 'QByteArray': ...

    def toPercentEncoding(self, exclude: typing.Union['QByteArray', bytes, bytearray] = ...,
    ...
    @typing.overload
    @staticmethod
    def fromBase64(base64: typing.Union['QByteArray', bytes, bytearray],
                   options: typing.Union['QByteArray.Base64Options', 'QByteArray.Base64Option']) -> 'QByteArray': ...
    ...
    @typing.overload
    def replace(self, before: typing.Union['QByteArray', bytes, bytearray],
                after: typing.Union['QByteArray', bytes, bytearray]) -> 'QByteArray': ...
...
class QCalendar(sip.simplewrapper):
    ...
    def dateTimeToString(self, format: str, datetime: typing.Union['QDateTime', datetime.datetime],
                         dateOnly: typing.Union['QDate', datetime.date], timeOnly: typing.Union['QTime', datetime.time],
                         locale: 'QLocale') -> str: ...
    ...
    def standaloneMonthName(self, locale: 'QLocale', month: int, year: int = ...,
                            format: 'QLocale.FormatType' = ...) -> str: ...
...
class QCommandLineOption(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, names: typing.Iterable[str], description: str, valueName: str = ...,
...
class QCommandLineParser(sip.simplewrapper):
    ...
    def setOptionsAfterPositionalArgumentsMode(self,
                                               mode: 'QCommandLineParser.OptionsAfterPositionalArgumentsMode') -> None: ...
...
class QCoreApplication(QObject):
    ...
    @staticmethod
    def processEvents(
            flags: typing.Union['QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag'] = ...) -> None: ...

    @typing.overload
    @staticmethod
    def processEvents(flags: typing.Union['QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag'],
                      maxtime: int) -> None: ...
...
class QCryptographicHash(sip.simplewrapper):
    ...
    @staticmethod
    def hash(data: typing.Union[QByteArray, bytes, bytearray],
             method: 'QCryptographicHash.Algorithm') -> QByteArray: ...
...
class QDateTime(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, date: typing.Union[QDate, datetime.date], time: typing.Union[QTime, datetime.time],
                 timeSpec: Qt.TimeSpec = ...) -> None: ...

    @typing.overload
    def __init__(self, year: int, month: int, day: int, hour: int, minute: int, second: int = ..., msec: int = ...,
                 timeSpec: int = ...) -> None: ...

    @typing.overload
    def __init__(self, date: typing.Union[QDate, datetime.date], time: typing.Union[QTime, datetime.time],
                 spec: Qt.TimeSpec, offsetSeconds: int) -> None: ...

    @typing.overload
    def __init__(self, date: typing.Union[QDate, datetime.date], time: typing.Union[QTime, datetime.time],
                 timeZone: 'QTimeZone') -> None: ...
...
class QDir(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, path: str, nameFilter: str, sort: 'QDir.SortFlags' = ...,
                 filters: 'QDir.Filters' = ...) -> None: ...
    ...
    @typing.overload
    def entryInfoList(self, filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ...,
                      sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> typing.List['QFileInfo']: ...

    @typing.overload
    def entryInfoList(self, nameFilters: typing.Iterable[str],
                      filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ...,
                      sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> typing.List['QFileInfo']: ...

    @typing.overload
    def entryList(self, filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ...,
                  sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> typing.List[str]: ...

    @typing.overload
    def entryList(self, nameFilters: typing.Iterable[str], filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ...,
                  sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> typing.List[str]: ...
...
class QDirIterator(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, path: str, nameFilters: typing.Iterable[str], filters: QDir.Filters = ...,
                 flags: 'QDirIterator.IteratorFlags' = ...) -> None: ...
...
class QEasingCurve(sip.simplewrapper):
    ...
    def addCubicBezierSegment(self, c1: typing.Union['QPointF', 'QPoint'], c2: typing.Union['QPointF', 'QPoint'],
                              endPoint: typing.Union['QPointF', 'QPoint']) -> None: ...
...
class QEventLoop(QObject):
    ...
    class ProcessEventsFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag']) -> None: ...
    ...
    @typing.overload
    def processEvents(self, flags: typing.Union[
        'QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag'] = ...) -> bool: ...

    @typing.overload
    def processEvents(self, flags: typing.Union['QEventLoop.ProcessEventsFlags', 'QEventLoop.ProcessEventsFlag'],
...
class QFileDevice(QIODevice):
    ...
    def setFileTime(self, newDate: typing.Union[QDateTime, datetime.datetime],
                    fileTime: 'QFileDevice.FileTime') -> bool: ...
    ...
    def setPermissions(self,
                       permissionSpec: typing.Union['QFileDevice.Permissions', 'QFileDevice.Permission']) -> bool: ...
...
class QFile(QFileDevice):
    ...
    @typing.overload
    @staticmethod
    def setPermissions(filename: str,
                       permissionSpec: typing.Union[QFileDevice.Permissions, QFileDevice.Permission]) -> bool: ...
    ...
    @typing.overload
    def open(self, fd: int, ioFlags: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag],
             handleFlags: typing.Union[QFileDevice.FileHandleFlags, QFileDevice.FileHandleFlag] = ...) -> bool: ...
...
class QItemSelectionModel(QObject):
    ...
    class SelectionFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QItemSelectionModel.SelectionFlags', 'QItemSelectionModel.SelectionFlag']) -> None: ...
    ...
    def setCurrentIndex(self, index: QModelIndex, command: typing.Union[
        'QItemSelectionModel.SelectionFlags', 'QItemSelectionModel.SelectionFlag']) -> None: ...

    @typing.overload
    def select(self, index: QModelIndex, command: typing.Union[
        'QItemSelectionModel.SelectionFlags', 'QItemSelectionModel.SelectionFlag']) -> None: ...

    @typing.overload
    def select(self, selection: 'QItemSelection', command: typing.Union[
        'QItemSelectionModel.SelectionFlags', 'QItemSelectionModel.SelectionFlag']) -> None: ...
...
class QItemSelection(sip.simplewrapper):
    ...
    def merge(self, other: 'QItemSelection',
              command: typing.Union[QItemSelectionModel.SelectionFlags, QItemSelectionModel.SelectionFlag]) -> None: ...
...
class QJsonDocument(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, object: typing.Dict[str, typing.Union[
        'QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]]) -> None: ...

    @typing.overload
    def __init__(self, array: typing.Iterable[typing.Union['QJsonValue', 'QJsonValue.Type', typing.Dict[
        str, 'QJsonValue'], bool, int, float, str]]) -> None: ...  # Keep primitive types
    ...
    def setArray(self, array: typing.Iterable[typing.Union['QJsonValue', 'QJsonValue.Type', typing.Dict[
        str, 'QJsonValue'], bool, int, float, str]]) -> None: ...  # Keep primitive types

    def setObject(self, object: typing.Dict[str, typing.Union[
        'QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]]) -> None: ...

    def array(self) -> typing.List['QJsonValue']: ...

    def object(self) -> typing.Dict[
        str, typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]]: ...
    ...
    @staticmethod
    def fromJson(json: typing.Union[QByteArray, bytes, bytearray],
                 error: typing.Optional[QJsonParseError] = ...) -> 'QJsonDocument': ...
    ...
    @staticmethod
    def fromBinaryData(data: typing.Union[QByteArray, bytes, bytearray],
                       validation: 'QJsonDocument.DataValidation' = ...) -> 'QJsonDocument': ...
...
class QJsonValue(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, other: typing.Union[
        'QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]) -> None: ...
    ...
    @typing.overload
    def toObject(self, defaultValue: typing.Dict[
        str, typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]]) -> \
    typing.Dict[
        str, typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, str]]: ...
    ...
    @typing.overload
    def toArray(self, defaultValue: typing.Iterable[
        typing.Union['QJsonValue', 'QJsonValue.Type', typing.Dict[str, 'QJsonValue'], bool, int, float, str]]) -> \
    typing.List['QJsonValue']: ...  # Keep primitive types
...
class QLineF(sip.simplewrapper):
    ...
    def intersect(self, l: 'QLineF',
                  intersectionPoint: typing.Union['QPointF', 'QPoint']) -> 'QLineF.IntersectType': ...
...
class QLocale(sip.simplewrapper):
    ...
    def formattedDataSize(self, bytes: int, precision: int = ...,
                          format: typing.Union['QLocale.DataSizeFormats', 'QLocale.DataSizeFormat'] = ...) -> str: ...
    ...
    @staticmethod
    def matchingLocales(language: 'QLocale.Language', script: 'QLocale.Script', country: 'QLocale.Country') -> \
    typing.List['QLocale']: ...
    ...
    @typing.overload
    def toString(self, dateTime: typing.Union[QDateTime, datetime.datetime],
                 format: 'QLocale.FormatType' = ...) -> str: ...

    @typing.overload
    def toString(self, dateTime: typing.Union[QDateTime, datetime.datetime], format: 'QLocale.FormatType',
                 cal: QCalendar) -> str: ...
    ...
    @typing.overload
    def toString(self, date: typing.Union[QDate, datetime.date], format: 'QLocale.FormatType',
                 cal: QCalendar) -> str: ...
...
class QMessageAuthenticationCode(sip.simplewrapper):
    ...
    def __init__(self, method: QCryptographicHash.Algorithm,
                 key: typing.Union[QByteArray, bytes, bytearray] = ...) -> None: ...

    @staticmethod
    def hash(message: typing.Union[QByteArray, bytes, bytearray], key: typing.Union[QByteArray, bytes, bytearray],
             method: QCryptographicHash.Algorithm) -> QByteArray: ...
...
class QMetaMethod(sip.simplewrapper):
    ...
    @typing.overload
    def invoke(self, object: QObject, connectionType: Qt.ConnectionType, returnValue: 'QGenericReturnArgument',
               value0: 'QGenericArgument' = ..., value1: 'QGenericArgument' = ..., value2: 'QGenericArgument' = ...,
               value3: 'QGenericArgument' = ..., value4: 'QGenericArgument' = ..., value5: 'QGenericArgument' = ...,
               value6: 'QGenericArgument' = ..., value7: 'QGenericArgument' = ..., value8: 'QGenericArgument' = ...,
               value9: 'QGenericArgument' = ...) -> typing.Any: ...

    @typing.overload
    def invoke(self, object: QObject, returnValue: 'QGenericReturnArgument', value0: 'QGenericArgument' = ...,
               value1: 'QGenericArgument' = ..., value2: 'QGenericArgument' = ..., value3: 'QGenericArgument' = ...,
               value4: 'QGenericArgument' = ..., value5: 'QGenericArgument' = ..., value6: 'QGenericArgument' = ...,
               value7: 'QGenericArgument' = ..., value8: 'QGenericArgument' = ...,
               value9: 'QGenericArgument' = ...) -> typing.Any: ...

    @typing.overload
    def invoke(self, object: QObject, connectionType: Qt.ConnectionType, value0: 'QGenericArgument' = ...,
               value1: 'QGenericArgument' = ..., value2: 'QGenericArgument' = ..., value3: 'QGenericArgument' = ...,
               value4: 'QGenericArgument' = ..., value5: 'QGenericArgument' = ..., value6: 'QGenericArgument' = ...,
               value7: 'QGenericArgument' = ..., value8: 'QGenericArgument' = ...,
               value9: 'QGenericArgument' = ...) -> typing.Any: ...
    ...
    @typing.overload
    def invoke(self, object: QObject, value0: 'QGenericArgument' = ..., value1: 'QGenericArgument' = ...,
               value2: 'QGenericArgument' = ..., value3: 'QGenericArgument' = ..., value4: 'QGenericArgument' = ...,
               value5: 'QGenericArgument' = ..., value6: 'QGenericArgument' = ..., value7: 'QGenericArgument' = ...,
               value8: 'QGenericArgument' = ..., value9: 'QGenericArgument' = ...) -> typing.Any: ...
...
class QMimeDatabase(sip.simplewrapper):
    ...
    @typing.overload
    def mimeTypeForFileNameAndData(self, fileName: str,
                                   data: typing.Union[QByteArray, bytes, bytearray]) -> 'QMimeType': ...
...
class QMetaObject(sip.simplewrapper):
    ...
    @typing.overload
    @staticmethod
    def invokeMethod(obj: QObject, member: str, type: Qt.ConnectionType, ret: 'QGenericReturnArgument',
                     value0: 'QGenericArgument' = ..., value1: 'QGenericArgument' = ...,
                     value2: 'QGenericArgument' = ..., value3: 'QGenericArgument' = ...,
                     value4: 'QGenericArgument' = ..., value5: 'QGenericArgument' = ...,
                     value6: 'QGenericArgument' = ..., value7: 'QGenericArgument' = ...,
                     value8: 'QGenericArgument' = ..., value9: 'QGenericArgument' = ...) -> typing.Any: ...

    @typing.overload
    @staticmethod
    def invokeMethod(obj: QObject, member: str, ret: 'QGenericReturnArgument', value0: 'QGenericArgument' = ...,
                     value1: 'QGenericArgument' = ..., value2: 'QGenericArgument' = ...,
                     value3: 'QGenericArgument' = ..., value4: 'QGenericArgument' = ...,
                     value5: 'QGenericArgument' = ..., value6: 'QGenericArgument' = ...,
                     value7: 'QGenericArgument' = ..., value8: 'QGenericArgument' = ...,
                     value9: 'QGenericArgument' = ...) -> typing.Any: ...

    @typing.overload
    @staticmethod
    def invokeMethod(obj: QObject, member: str, type: Qt.ConnectionType, value0: 'QGenericArgument' = ...,
                     value1: 'QGenericArgument' = ..., value2: 'QGenericArgument' = ...,
                     value3: 'QGenericArgument' = ..., value4: 'QGenericArgument' = ...,
                     value5: 'QGenericArgument' = ..., value6: 'QGenericArgument' = ...,
                     value7: 'QGenericArgument' = ..., value8: 'QGenericArgument' = ...,
    ...
    @typing.overload
    @staticmethod
    def invokeMethod(obj: QObject, member: str, value0: 'QGenericArgument' = ..., value1: 'QGenericArgument' = ...,
                     value2: 'QGenericArgument' = ..., value3: 'QGenericArgument' = ...,
                     value4: 'QGenericArgument' = ..., value5: 'QGenericArgument' = ...,
                     value6: 'QGenericArgument' = ..., value7: 'QGenericArgument' = ...,
                     value8: 'QGenericArgument' = ..., value9: 'QGenericArgument' = ...) -> typing.Any: ...
...
class QOperatingSystemVersion(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, osType: 'QOperatingSystemVersion.OSType', vmajor: int, vminor: int = ...,
                 vmicro: int = ...) -> None: ...
...
class QPropertyAnimation(QVariantAnimation):
    ...
    @typing.overload
    def __init__(self, target: QObject, propertyName: typing.Union[QByteArray, bytes, bytearray],
...
class QProcess(QIODevice):
    ...
    def setStandardErrorFile(self, fileName: str,
                             mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...) -> None: ...

    def setStandardOutputFile(self, fileName: str,
                              mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...) -> None: ...
    ...
    @typing.overload  # type: ignore
    @staticmethod
    def startDetached(program: str, arguments: typing.Iterable[str], workingDirectory: str) -> typing.Tuple[
        bool, int]: ...
    ...
    @typing.overload
    def start(self, program: str, arguments: typing.Iterable[str],
              mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...) -> None: ...
...
class QRandomGenerator(sip.simplewrapper):
    ...
    @typing.overload
    def bounded(self, highest: int) -> int: ...  # type: ignore
...
class QRectF(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, atopLeft: typing.Union[QPointF, QPoint],
                 abottomRight: typing.Union[QPointF, QPoint]) -> None: ...
...
class QRegularExpression(sip.simplewrapper):
    ...
    class PatternOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QRegularExpression.PatternOptions', 'QRegularExpression.PatternOption']) -> None: ...
    ...
    class MatchOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QRegularExpression.MatchOptions', 'QRegularExpression.MatchOption']) -> None: ...
    ...
    @typing.overload
    def __init__(self, pattern: str, options: typing.Union[
        'QRegularExpression.PatternOptions', 'QRegularExpression.PatternOption'] = ...) -> None: ...
    ...
    def globalMatch(self, subject: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ...,
                    matchOptions: typing.Union[
                        'QRegularExpression.MatchOptions', 'QRegularExpression.MatchOption'] = ...) -> 'QRegularExpressionMatchIterator': ...

    def match(self, subject: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ...,
              matchOptions: typing.Union[
                  'QRegularExpression.MatchOptions', 'QRegularExpression.MatchOption'] = ...) -> 'QRegularExpressionMatch': ...
    ...
    def setPatternOptions(self, options: typing.Union[
        'QRegularExpression.PatternOptions', 'QRegularExpression.PatternOption']) -> None: ...
...
class QSettings(QObject):
    ...
    @typing.overload
    def __init__(self, scope: 'QSettings.Scope', organization: str, application: str = ...,
                 parent: typing.Optional[QObject] = ...) -> None: ...

    @typing.overload
    def __init__(self, format: 'QSettings.Format', scope: 'QSettings.Scope', organization: str, application: str = ...,
                 parent: typing.Optional[QObject] = ...) -> None: ...
...
class QSocketNotifier(QObject):
    ...
    def __init__(self, socket: sip.voidptr, a1: 'QSocketNotifier.Type',
                 parent: typing.Optional[QObject] = ...) -> None: ...
...
class QStandardPaths(sip.simplewrapper):
    ...
    @staticmethod
    def locateAll(type: 'QStandardPaths.StandardLocation', fileName: str,
                  options: 'QStandardPaths.LocateOptions' = ...) -> typing.List[str]: ...

    @staticmethod
    def locate(type: 'QStandardPaths.StandardLocation', fileName: str,
               options: 'QStandardPaths.LocateOptions' = ...) -> str: ...
...
class QStringListModel(QAbstractListModel):
    ...
    def data(self, index: QModelIndex, role: int) -> typing.Any: ...  # type: ignore
...
class QTextBoundaryFinder(sip.simplewrapper):
    ...
    class BoundaryReasons(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QTextBoundaryFinder.BoundaryReasons', 'QTextBoundaryFinder.BoundaryReason']) -> None: ...
...
class QTextCodec(sip.wrapper):
    ...
    class ConverterState(sip.simplewrapper):
        ...
        def __init__(self,
                     flags: typing.Union['QTextCodec.ConversionFlags', 'QTextCodec.ConversionFlag'] = ...) -> None: ...
    ...
    def makeEncoder(self, flags: typing.Union[
        'QTextCodec.ConversionFlags', 'QTextCodec.ConversionFlag'] = ...) -> 'QTextEncoder': ...

    def makeDecoder(self, flags: typing.Union[
        'QTextCodec.ConversionFlags', 'QTextCodec.ConversionFlag'] = ...) -> 'QTextDecoder': ...
...
class QTextEncoder(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, codec: QTextCodec,
                 flags: typing.Union[QTextCodec.ConversionFlags, QTextCodec.ConversionFlag]) -> None: ...
...
class QTextStream(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, array: QByteArray,
                 mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...) -> None: ...
...
class QTimeZone(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, zoneId: typing.Union[QByteArray, bytes, bytearray], offsetSeconds: int, name: str,
                 abbreviation: str, country: QLocale.Country = ..., comment: str = ...) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: typing.Union[QByteArray, bytes, bytearray], country: QLocale.Country) -> \
    ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(windowsId: typing.Union[QByteArray, bytes, bytearray],
                                 country: QLocale.Country) -> QByteArray: ...
    ...
    def transitions(self, fromDateTime: typing.Union[QDateTime, datetime.datetime],
                    toDateTime: typing.Union[QDateTime, datetime.datetime]) -> typing.List['QTimeZone.OffsetData']: ...

    def previousTransition(self,
                           beforeDateTime: typing.Union[QDateTime, datetime.datetime]) -> 'QTimeZone.OffsetData': ...
    ...
    @typing.overload
    def displayName(self, atDateTime: typing.Union[QDateTime, datetime.datetime], nameType: 'QTimeZone.NameType' = ...,
                    locale: QLocale = ...) -> str: ...

    @typing.overload
    def displayName(self, timeType: 'QTimeZone.TimeType', nameType: 'QTimeZone.NameType' = ...,
                    locale: QLocale = ...) -> str: ...
...
class QTranslator(QObject):
    ...
    @typing.overload
    def load(self, locale: QLocale, fileName: str, prefix: str = ..., directory: str = ...,
             suffix: str = ...) -> bool: ...

    def isEmpty(self) -> bool: ...

    def translate(self, context: str, sourceText: str, disambiguation: typing.Optional[str] = ...,
                  n: int = ...) -> str: ...
...
class QUrl(sip.simplewrapper):
    ...
    class ComponentFormattingOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption']) -> None: ...
    ...
    class UserInputResolutionOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QUrl.UserInputResolutionOptions', 'QUrl.UserInputResolutionOption']) -> None: ...
    ...
    def fileName(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...
    ...
    def query(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...
    ...
    def topLevelDomain(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...
    ...
    @typing.overload
    @staticmethod
    def fromUserInput(userInput: str, workingDirectory: str, options: typing.Union[
        'QUrl.UserInputResolutionOptions', 'QUrl.UserInputResolutionOption'] = ...) -> 'QUrl': ...
    ...
    @staticmethod
    def toPercentEncoding(input: str, exclude: typing.Union[QByteArray, bytes, bytearray] = ...,
    ...
    def fragment(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...

    def setFragment(self, fragment: str, mode: 'QUrl.ParsingMode' = ...) -> None: ...

    def path(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...
    ...
    def host(self,
             a0: typing.Union['QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...

    def setHost(self, host: str, mode: 'QUrl.ParsingMode' = ...) -> None: ...

    def password(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...

    def setPassword(self, password: str, mode: 'QUrl.ParsingMode' = ...) -> None: ...

    def userName(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...

    def setUserName(self, userName: str, mode: 'QUrl.ParsingMode' = ...) -> None: ...

    def userInfo(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...

    def setUserInfo(self, userInfo: str, mode: 'QUrl.ParsingMode' = ...) -> None: ...

    def authority(self, options: typing.Union[
        'QUrl.ComponentFormattingOptions', 'QUrl.ComponentFormattingOption'] = ...) -> str: ...
...
class QUrlQuery(sip.simplewrapper):
    ...
    def allQueryItemValues(self, key: str, options: typing.Union[
        QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> typing.List[str]: ...

    def queryItemValue(self, key: str, options: typing.Union[
        QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> str: ...
    ...
    def queryItems(self,
                   options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> \
    ...
    def toString(self, options: typing.Union[
        QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> str: ...

    def setQuery(self, queryString: str) -> None: ...

    def query(self,
              options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> str: ...
...
class QUuid(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, l: int, w1: int, w2: int, b1: int, b2: int, b3: int, b4: int, b5: int, b6: int, b7: int,
                 b8: int) -> None: ...
...
class QXmlStreamReader(sip.simplewrapper):
    ...
    def addExtraNamespaceDeclarations(self, extraNamespaceDeclaractions: typing.Iterable[
        QXmlStreamNamespaceDeclaration]) -> None: ...
...
def pyqtSlot(*types: typing.Any, name: typing.Optional[str] = ..., result: typing.Optional[str] = ...) -> \
...
def qInstallMessageHandler(a0: typing.Optional[typing.Callable[[QtMsgType, QMessageLogContext, str], None]]) -> \
