...
class QSqlDriver(QtCore.QObject):
    ...
    def open(self, db: str, user: str = ..., password: str = ..., host: str = ..., port: int = ...,
             options: str = ...) -> bool: ...
    ...
    def sqlStatement(self, type: 'QSqlDriver.StatementType', tableName: str, rec: 'QSqlRecord',
                     preparedStatement: bool) -> str: ...
...
class QSqlError(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, driverText: str = ..., databaseText: str = ..., type: 'QSqlError.ErrorType' = ...,
                 errorCode: str = ...) -> None: ...
...
class QSqlQuery(sip.simplewrapper):
    ...
    def addBindValue(self, val: typing.Any,
                     type: typing.Union['QSql.ParamType', 'QSql.ParamTypeFlag'] = ...) -> None: ...

    @typing.overload
    def bindValue(self, placeholder: str, val: typing.Any,
                  type: typing.Union['QSql.ParamType', 'QSql.ParamTypeFlag'] = ...) -> None: ...

    @typing.overload
    def bindValue(self, pos: int, val: typing.Any,
                  type: typing.Union['QSql.ParamType', 'QSql.ParamTypeFlag'] = ...) -> None: ...
...
class QSqlRelationalTableModel(QSqlTableModel):
    ...
    def setData(self, index: QtCore.QModelIndex, value: typing.Any,
                role: int = ...) -> bool: ...  # Rename first argument from item to index

    def data(self, index: QtCore.QModelIndex,
             role: int = ...) -> typing.Any: ...  # Rename first argument from item to index
