...
class QAbstractPrintDialog(QtWidgets.QDialog):
    ...
    class PrintDialogOptions(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QAbstractPrintDialog.PrintDialogOptions', 'QAbstractPrintDialog.PrintDialogOption']) -> None: ...
    ...
    def setEnabledOptions(self, options: typing.Union[
        'QAbstractPrintDialog.PrintDialogOptions', 'QAbstractPrintDialog.PrintDialogOption']) -> None: ...
...
class QPrinter(QtGui.QPagedPaintDevice):
    ...
    def setPageMargins(self, left: float, top: float, right: float, bottom: float,
                       unit: 'QPrinter.Unit') -> None: ...  # type: ignore
...
class QPrintPreviewDialog(QtWidgets.QDialog):
    ...
    @typing.overload
    def __init__(self, printer: QPrinter, parent: typing.Optional[QtWidgets.QWidget] = ...,
                 flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...) -> None: ...
