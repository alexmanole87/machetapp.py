...
class QAbstractOAuth(QtCore.QObject):
    ...
    def prepareRequest(self, request: QtNetwork.QNetworkRequest,
                       verb: typing.Union[QtCore.QByteArray, bytes, bytearray],
                       body: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...
    ...
    def deleteResource(self, url: QtCore.QUrl,
                       parameters: typing.Dict[str, typing.Any] = ...) -> QtNetwork.QNetworkReply: ...
...
class QAbstractOAuth2(QAbstractOAuth):
    ...
    @typing.overload
    def __init__(self, manager: QtNetwork.QNetworkAccessManager,
    ...
    @typing.overload
    def put(self, url: QtCore.QUrl,
            data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> QtNetwork.QNetworkReply: ...
    ...
    def createAuthenticatedUrl(self, url: QtCore.QUrl,
                               parameters: typing.Dict[str, typing.Any] = ...) -> QtCore.QUrl: ...
...
class QOAuth1(QAbstractOAuth):
    ...
    @typing.overload
    def __init__(self, clientIdentifier: str, clientSharedSecret: str, manager: QtNetwork.QNetworkAccessManager,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    @typing.overload
    def setup(self, request: QtNetwork.QNetworkRequest, signingParameters: typing.Dict[str, typing.Any],
              operation: QtNetwork.QNetworkAccessManager.Operation) -> None: ...

    @typing.overload
    def setup(self, request: QtNetwork.QNetworkRequest, signingParameters: typing.Dict[str, typing.Any],
              operationVerb: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def requestTokenCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl,
                                temporaryToken: typing.Tuple[str, str],
                                parameters: typing.Dict[str, typing.Any] = ...) -> QtNetwork.QNetworkReply: ...

    def requestTemporaryCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl,
                                    parameters: typing.Dict[str, typing.Any] = ...) -> QtNetwork.QNetworkReply: ...
...
class QOAuth1Signature(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl = ..., method: 'QOAuth1Signature.HttpRequestMethod' = ...,
                 parameters: typing.Dict[str, typing.Any] = ...) -> None: ...

    @typing.overload
    def __init__(self, url: QtCore.QUrl, clientSharedKey: str, tokenSecret: str,
...
class QOAuth2AuthorizationCodeFlow(QAbstractOAuth2):
    ...
    @typing.overload
    def __init__(self, clientIdentifier: str, manager: QtNetwork.QNetworkAccessManager,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...

    @typing.overload
    def __init__(self, authorizationUrl: QtCore.QUrl, accessTokenUrl: QtCore.QUrl,
                 manager: QtNetwork.QNetworkAccessManager, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...

    @typing.overload
    def __init__(self, clientIdentifier: str, authorizationUrl: QtCore.QUrl, accessTokenUrl: QtCore.QUrl,
                 manager: QtNetwork.QNetworkAccessManager, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QOAuthHttpServerReplyHandler(QOAuthOobReplyHandler):
    ...
    @typing.overload
    def __init__(self, address: typing.Union[QtNetwork.QHostAddress, QtNetwork.QHostAddress.SpecialAddress], port: int,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def listen(self, address: typing.Union[QtNetwork.QHostAddress, QtNetwork.QHostAddress.SpecialAddress] = ...,
               port: int = ...) -> bool: ...
