...
class QVideoFilterRunnable(sip.simplewrapper):
    ...
    class RunFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QVideoFilterRunnable.RunFlags', 'QVideoFilterRunnable.RunFlag']) -> None: ...
    ...
    def run(self, input: 'QVideoFrame', surfaceFormat: 'QVideoSurfaceFormat',
            flags: typing.Union['QVideoFilterRunnable.RunFlags', 'QVideoFilterRunnable.RunFlag']) -> 'QVideoFrame': ...
...
class QAbstractVideoSurface(QtCore.QObject):
    ...
    def supportedPixelFormats(self, type: QAbstractVideoBuffer.HandleType = ...) -> typing.List[
...
class QAudioBuffer(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: 'QAudioFormat',
                 startTime: int = ...) -> None: ...
...
class QAudioInput(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, audioDevice: QAudioDeviceInfo, format: QAudioFormat = ...,
...
class QMediaRecorder(QtCore.QObject, QMediaBindableInterface):
    ...
    def setEncodingSettings(self, audio: 'QAudioEncoderSettings', video: 'QVideoEncoderSettings' = ...,
                            container: str = ...) -> None: ...
    ...
    def supportedFrameRates(self, settings: 'QVideoEncoderSettings' = ...) -> typing.Tuple[
        typing.List[float], bool]: ...

    def supportedResolutions(self, settings: 'QVideoEncoderSettings' = ...) -> typing.Tuple[
        typing.List[QtCore.QSize], bool]: ...

    def videoCodecDescription(self, codecName: str) -> str: ...

    def supportedVideoCodecs(self) -> typing.List[str]: ...

    def supportedAudioSampleRates(self, settings: 'QAudioEncoderSettings' = ...) -> typing.Tuple[
...
class QCamera(QMediaObject):
    ...
    @typing.overload
    def __init__(self, device: typing.Union[QtCore.QByteArray, bytes, bytearray],
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def supportedViewfinderPixelFormats(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.List[
        'QVideoFrame.PixelFormat']: ...

    def supportedViewfinderFrameRateRanges(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.List[
        'QCamera.FrameRateRange']: ...

    def supportedViewfinderResolutions(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.List[
        QtCore.QSize]: ...

    def supportedViewfinderSettings(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.List[
    ...
    @typing.overload
    def lockStatusChanged(self, a0: 'QCamera.LockType', a1: 'QCamera.LockStatus',
                          a2: 'QCamera.LockChangeReason') -> None: ...
...
class QCameraCaptureDestinationControl(QMediaControl):
    ...
    def captureDestinationChanged(self, destination: typing.Union[
        'QCameraImageCapture.CaptureDestinations', 'QCameraImageCapture.CaptureDestination']) -> None: ...

    def setCaptureDestination(self, destination: typing.Union[
        'QCameraImageCapture.CaptureDestinations', 'QCameraImageCapture.CaptureDestination']) -> None: ...

    def captureDestination(self) -> 'QCameraImageCapture.CaptureDestinations': ...

    def isCaptureDestinationSupported(self, destination: typing.Union[
        'QCameraImageCapture.CaptureDestinations', 'QCameraImageCapture.CaptureDestination']) -> bool: ...
...
class QCameraExposure(QtCore.QObject):
    ...
    def isFlashModeSupported(self,
                             mode: typing.Union['QCameraExposure.FlashModes', 'QCameraExposure.FlashMode']) -> bool: ...
...
class QCameraExposureControl(QMediaControl):
    ...
    def supportedParameterRange(self, parameter: 'QCameraExposureControl.ExposureParameter') -> typing.Tuple[
        typing.List[typing.Any], bool]: ...
...
class QCameraImageCapture(QtCore.QObject, QMediaBindableInterface):
    ...
    def captureDestinationChanged(self, a0: typing.Union[
        'QCameraImageCapture.CaptureDestinations', 'QCameraImageCapture.CaptureDestination']) -> None: ...
    ...
    def supportedResolutions(self, settings: 'QImageEncoderSettings' = ...) -> typing.Tuple[
        typing.List[QtCore.QSize], bool]: ...
...
class QCameraImageProcessingControl(QMediaControl):
    ...
    def setParameter(self, parameter: 'QCameraImageProcessingControl.ProcessingParameter',
                     value: typing.Any) -> None: ...

    def parameter(self, parameter: 'QCameraImageProcessingControl.ProcessingParameter') -> typing.Any: ...

    def isParameterValueSupported(self, parameter: 'QCameraImageProcessingControl.ProcessingParameter',
...
class QCameraLocksControl(QMediaControl):
    ...
    def lockStatusChanged(self, type: QCamera.LockType, status: QCamera.LockStatus,
                          reason: QCamera.LockChangeReason) -> None: ...
...
class QCameraViewfinderSettingsControl(QMediaControl):
    ...
    def setViewfinderParameter(self, parameter: 'QCameraViewfinderSettingsControl.ViewfinderParameter',
                               value: typing.Any) -> None: ...

    def viewfinderParameter(self, parameter: 'QCameraViewfinderSettingsControl.ViewfinderParameter') -> typing.Any: ...

    def isViewfinderParameterSupported(self,
                                       parameter: 'QCameraViewfinderSettingsControl.ViewfinderParameter') -> bool: ...
...
class QMediaPlayer(QMediaObject):
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...,
                 flags: typing.Union['QMediaPlayer.Flags', 'QMediaPlayer.Flag'] = ...) -> None: ...
    ...
    @staticmethod
    def supportedMimeTypes(flags: typing.Union['QMediaPlayer.Flags', 'QMediaPlayer.Flag'] = ...) -> typing.List[
        str]: ...

    @staticmethod
    def hasSupport(mimeType: str, codecs: typing.Iterable[str] = ..., flags: typing.Union[
        'QMediaPlayer.Flags', 'QMediaPlayer.Flag'] = ...) -> 'QMultimedia.SupportEstimate': ...
...
class QVideoFrame(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, bytes: int, size: QtCore.QSize, bytesPerLine: int,
                 format: 'QVideoFrame.PixelFormat') -> None: ...
...
class QVideoSurfaceFormat(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, size: QtCore.QSize, format: QVideoFrame.PixelFormat,
                 type: QAbstractVideoBuffer.HandleType = ...) -> None: ...
