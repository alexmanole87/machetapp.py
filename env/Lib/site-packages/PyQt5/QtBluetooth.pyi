...
class QBluetooth(sip.simplewrapper):
    ...
    class AttAccessConstraints(sip.wrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QBluetooth.AttAccessConstraints', 'QBluetooth.AttAccessConstraint']) -> None: ...
...
class QBluetoothDeviceDiscoveryAgent(QtCore.QObject):
    ...
    class DiscoveryMethods(sip.wrapper):
        ...
        def __init__(self, f: typing.Union[
            'QBluetoothDeviceDiscoveryAgent.DiscoveryMethods', 'QBluetoothDeviceDiscoveryAgent.DiscoveryMethod']) -> None: ...
    ...
    def deviceUpdated(self, info: 'QBluetoothDeviceInfo', updatedFields: typing.Union[
        'QBluetoothDeviceInfo.Fields', 'QBluetoothDeviceInfo.Field']) -> None: ...
    ...
    @typing.overload
    def start(self, method: typing.Union[
        'QBluetoothDeviceDiscoveryAgent.DiscoveryMethods', 'QBluetoothDeviceDiscoveryAgent.DiscoveryMethod']) -> None: ...
...
class QBluetoothDeviceInfo(sip.wrapper):
    ...
    class ServiceClasses(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QBluetoothDeviceInfo.ServiceClasses', 'QBluetoothDeviceInfo.ServiceClass']) -> None: ...
    ...
    class CoreConfigurations(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QBluetoothDeviceInfo.CoreConfigurations', 'QBluetoothDeviceInfo.CoreConfiguration']) -> None: ...
    ...
    def setManufacturerData(self, manufacturerId: int,
                            data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> bool: ...
    ...
    def setCoreConfigurations(self, coreConfigs: typing.Union[
        'QBluetoothDeviceInfo.CoreConfigurations', 'QBluetoothDeviceInfo.CoreConfiguration']) -> None: ...
    ...
    @typing.overload
    def setServiceUuids(self, uuids: typing.Iterable['QBluetoothUuid'],
                        completeness: 'QBluetoothDeviceInfo.DataCompleteness') -> None: ...
...
class QBluetoothServer(QtCore.QObject):
    ...
    def __init__(self, serverType: 'QBluetoothServiceInfo.Protocol',
...
class QBluetoothSocket(QtCore.QIODevice):
    ...
    @typing.overload
    def __init__(self, socketType: QBluetoothServiceInfo.Protocol,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def doDeviceDiscovery(self, service: QBluetoothServiceInfo,
                          openMode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag]) -> None: ...
    ...
    def setSocketDescriptor(self, socketDescriptor: int, socketType: QBluetoothServiceInfo.Protocol,
                            state: 'QBluetoothSocket.SocketState' = ..., mode: typing.Union[
    ...
    @typing.overload
    def connectToService(self, service: QBluetoothServiceInfo, mode: typing.Union[
        QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> None: ...

    @typing.overload
    def connectToService(self, address: QBluetoothAddress, uuid: 'QBluetoothUuid', mode: typing.Union[
        QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> None: ...

    @typing.overload
    def connectToService(self, address: QBluetoothAddress, port: int, mode: typing.Union[
        QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...) -> None: ...
...
class QBluetoothUuid(QtCore.QUuid):
    ...
    @typing.overload
    def __init__(self, uuid: typing.Tuple[
    ...
    def toUInt128(self) -> typing.Tuple[
...
class QLowEnergyAdvertisingParameters(sip.wrapper):
    ...
    def setWhiteList(self, whiteList: typing.Iterable['QLowEnergyAdvertisingParameters.AddressInfo'],
                     policy: 'QLowEnergyAdvertisingParameters.FilterPolicy') -> None: ...
...
class QLowEnergyCharacteristic(sip.wrapper):
    ...
    class PropertyTypes(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QLowEnergyCharacteristic.PropertyTypes', 'QLowEnergyCharacteristic.PropertyType']) -> None: ...
...
class QLowEnergyCharacteristicData(sip.wrapper):
    ...
    def setWriteConstraints(self, constraints: typing.Union[
        QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint]) -> None: ...

    def readConstraints(self) -> QBluetooth.AttAccessConstraints: ...

    def setReadConstraints(self, constraints: typing.Union[
        QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint]) -> None: ...
    ...
    def setProperties(self, properties: typing.Union[
        QLowEnergyCharacteristic.PropertyTypes, QLowEnergyCharacteristic.PropertyType]) -> None: ...
...
class QLowEnergyController(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, remoteDevice: QBluetoothAddress, localDevice: QBluetoothAddress,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def addService(self, service: 'QLowEnergyServiceData',
                   parent: typing.Optional[QtCore.QObject] = ...) -> 'QLowEnergyService': ...

    def stopAdvertising(self) -> None: ...

    def startAdvertising(self, parameters: QLowEnergyAdvertisingParameters, advertisingData: QLowEnergyAdvertisingData,
                         scanResponseData: QLowEnergyAdvertisingData = ...) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def createCentral(remoteDevice: QBluetoothDeviceInfo,
                      parent: typing.Optional[QtCore.QObject] = ...) -> 'QLowEnergyController': ...

    @typing.overload
    @staticmethod
    def createCentral(remoteDevice: QBluetoothAddress, localDevice: QBluetoothAddress,
                      parent: typing.Optional[QtCore.QObject] = ...) -> 'QLowEnergyController': ...
    ...
    def createServiceObject(self, service: QBluetoothUuid,
                            parent: typing.Optional[QtCore.QObject] = ...) -> 'QLowEnergyService': ...
...
class QLowEnergyDescriptorData(sip.wrapper):
    ...
    def setWritePermissions(self, writable: bool, constraints: typing.Union[
        QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint] = ...) -> None: ...
    ...
    def setReadPermissions(self, readable: bool, constraints: typing.Union[
        QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint] = ...) -> None: ...
...
class QLowEnergyService(QtCore.QObject):
    ...
    class ServiceTypes(sip.wrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QLowEnergyService.ServiceTypes', 'QLowEnergyService.ServiceType']) -> None: ...
    ...
    def descriptorRead(self, info: QLowEnergyDescriptor,
                       value: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def characteristicRead(self, info: QLowEnergyCharacteristic,
                           value: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...
    ...
    def descriptorWritten(self, info: QLowEnergyDescriptor,
                          value: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def characteristicWritten(self, info: QLowEnergyCharacteristic,
                              value: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def characteristicChanged(self, info: QLowEnergyCharacteristic,
                              value: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def stateChanged(self, newState: 'QLowEnergyService.ServiceState') -> None: ...

    def writeDescriptor(self, descriptor: QLowEnergyDescriptor,
                        newValue: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...

    def writeCharacteristic(self, characteristic: QLowEnergyCharacteristic,
                            newValue: typing.Union[QtCore.QByteArray, bytes, bytearray],
                            mode: 'QLowEnergyService.WriteMode' = ...) -> None: ...
