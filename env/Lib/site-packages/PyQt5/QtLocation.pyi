...
class QGeoCodeReply(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, error: 'QGeoCodeReply.Error', errorString: str,
...
class QGeoCodingManager(QtCore.QObject):
    ...
    def reverseGeocode(self, coordinate: QtPositioning.QGeoCoordinate,
                       bounds: QtPositioning.QGeoShape = ...) -> QGeoCodeReply: ...

    @typing.overload
    def geocode(self, address: QtPositioning.QGeoAddress, bounds: QtPositioning.QGeoShape = ...) -> QGeoCodeReply: ...

    @typing.overload
    def geocode(self, searchString: str, limit: int = ..., offset: int = ...,
                bounds: QtPositioning.QGeoShape = ...) -> QGeoCodeReply: ...
...
class QGeoRouteReply(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, error: 'QGeoRouteReply.Error', errorString: str,
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QGeoRouteRequest(sip.simplewrapper):
    ...
    class FeatureTypes(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QGeoRouteRequest.FeatureTypes', 'QGeoRouteRequest.FeatureType']) -> None: ...
    ...
    class FeatureWeights(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QGeoRouteRequest.FeatureWeights', 'QGeoRouteRequest.FeatureWeight']) -> None: ...
    ...
    class RouteOptimizations(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QGeoRouteRequest.RouteOptimizations', 'QGeoRouteRequest.RouteOptimization']) -> None: ...
    ...
    class SegmentDetails(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QGeoRouteRequest.SegmentDetails', 'QGeoRouteRequest.SegmentDetail']) -> None: ...
    ...
    class ManeuverDetails(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoRouteRequest.ManeuverDetails', 'QGeoRouteRequest.ManeuverDetail']) -> None: ...
    ...
    def setFeatureWeight(self, featureType: 'QGeoRouteRequest.FeatureType',
                         featureWeight: 'QGeoRouteRequest.FeatureWeight') -> None: ...

    def travelModes(self) -> 'QGeoRouteRequest.TravelModes': ...

    def setTravelModes(self, travelModes: typing.Union[
        'QGeoRouteRequest.TravelModes', 'QGeoRouteRequest.TravelMode']) -> None: ...
...
class QGeoRoutingManagerEngine(QtCore.QObject):
    ...
    def setSupportedManeuverDetails(self, maneuverDetails: typing.Union[
        QGeoRouteRequest.ManeuverDetails, QGeoRouteRequest.ManeuverDetail]) -> None: ...

    def setSupportedSegmentDetails(self, segmentDetails: typing.Union[
        QGeoRouteRequest.SegmentDetails, QGeoRouteRequest.SegmentDetail]) -> None: ...

    def setSupportedRouteOptimizations(self, optimizations: typing.Union[
        QGeoRouteRequest.RouteOptimizations, QGeoRouteRequest.RouteOptimization]) -> None: ...

    def setSupportedFeatureWeights(self, featureWeights: typing.Union[
        QGeoRouteRequest.FeatureWeights, QGeoRouteRequest.FeatureWeight]) -> None: ...

    def setSupportedFeatureTypes(self, featureTypes: typing.Union[
        QGeoRouteRequest.FeatureTypes, QGeoRouteRequest.FeatureType]) -> None: ...

    def setSupportedTravelModes(self, travelModes: typing.Union[
        QGeoRouteRequest.TravelModes, QGeoRouteRequest.TravelMode]) -> None: ...
...
class QGeoServiceProvider(QtCore.QObject):
    ...
    class RoutingFeatures(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoServiceProvider.RoutingFeatures', 'QGeoServiceProvider.RoutingFeature']) -> None: ...
    ...
    class GeocodingFeatures(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoServiceProvider.GeocodingFeatures', 'QGeoServiceProvider.GeocodingFeature']) -> None: ...
    ...
    class MappingFeatures(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoServiceProvider.MappingFeatures', 'QGeoServiceProvider.MappingFeature']) -> None: ...
    ...
    class PlacesFeatures(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoServiceProvider.PlacesFeatures', 'QGeoServiceProvider.PlacesFeature']) -> None: ...
    ...
    class NavigationFeatures(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoServiceProvider.NavigationFeatures', 'QGeoServiceProvider.NavigationFeature']) -> None: ...
    ...
    def __init__(self, providerName: str, parameters: typing.Dict[str, typing.Any] = ...,
                 allowExperimental: bool = ...) -> None: ...
...
class QPlaceIdReply(QPlaceReply):
    ...
    def __init__(self, operationType: 'QPlaceIdReply.OperationType',
                 parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QPlaceSearchRequest(sip.simplewrapper):
    ...
    def setVisibilityScope(self,
                           visibilityScopes: typing.Union[QLocation.VisibilityScope, QLocation.Visibility]) -> None: ...
