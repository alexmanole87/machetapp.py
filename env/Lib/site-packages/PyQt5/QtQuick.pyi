...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    def updateInputMethod(self, queries: typing.Union[
        QtCore.Qt.InputMethodQueries, QtCore.Qt.InputMethodQuery] = ...) -> None: ...
...
class QQuickImageProvider(QtQml.QQmlImageProviderBase):
    ...
    @typing.overload
    def __init__(self, type: QtQml.QQmlImageProviderBase.ImageType, flags: typing.Union[
        QtQml.QQmlImageProviderBase.Flags, QtQml.QQmlImageProviderBase.Flag] = ...) -> None: ...

    @typing.overload
    def __init__(self, a0: 'QQuickImageProvider') -> None: ...

    def requestTexture(self, id: str, requestedSize: QtCore.QSize) -> typing.Tuple[
        QQuickTextureFactory, QtCore.QSize]: ...
...
class QQuickPaintedItem(QQuickItem):
    ...
    class PerformanceHints(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QQuickPaintedItem.PerformanceHints', 'QQuickPaintedItem.PerformanceHint']) -> None: ...
    ...
    def setPerformanceHints(self, hints: typing.Union[
        'QQuickPaintedItem.PerformanceHints', 'QQuickPaintedItem.PerformanceHint']) -> None: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    class CreateTextureOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QQuickWindow.CreateTextureOptions', 'QQuickWindow.CreateTextureOption']) -> None: ...
    ...
    def createTextureFromNativeObject(self, type: 'QQuickWindow.NativeObjectType', nativeObjectPtr: sip.voidptr,
                                      nativeLayout: int, size: QtCore.QSize, options: typing.Union[
                'QQuickWindow.CreateTextureOptions', 'QQuickWindow.CreateTextureOption'] = ...) -> 'QSGTexture': ...

    def createTextureFromId(self, id: int, size: QtCore.QSize, options: typing.Union[
        'QQuickWindow.CreateTextureOptions', 'QQuickWindow.CreateTextureOption'] = ...) -> 'QSGTexture': ...
    ...
    @typing.overload
    def createTextureFromImage(self, image: QtGui.QImage, options: typing.Union[
        'QQuickWindow.CreateTextureOptions', 'QQuickWindow.CreateTextureOption']) -> 'QSGTexture': ...
...
class QSGAbstractRenderer(QtCore.QObject):
    ...
    class ClearMode(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QSGAbstractRenderer.ClearMode', 'QSGAbstractRenderer.ClearModeBit']) -> None: ...
    ...
    class MatrixTransformFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QSGAbstractRenderer.MatrixTransformFlags', 'QSGAbstractRenderer.MatrixTransformFlag']) -> None: ...
    ...
    def setClearMode(self, mode: typing.Union[
        'QSGAbstractRenderer.ClearMode', 'QSGAbstractRenderer.ClearModeBit']) -> None: ...
    ...
    @typing.overload
    def setProjectionMatrixToRect(self, rect: QtCore.QRectF, flags: typing.Union[
        'QSGAbstractRenderer.MatrixTransformFlags', 'QSGAbstractRenderer.MatrixTransformFlag']) -> None: ...
...
class QSGEngine(QtCore.QObject):
    ...
    class CreateTextureOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QSGEngine.CreateTextureOptions', 'QSGEngine.CreateTextureOption']) -> None: ...
    ...
    def createTextureFromId(self, id: int, size: QtCore.QSize, options: typing.Union[
        'QSGEngine.CreateTextureOptions', 'QSGEngine.CreateTextureOption'] = ...) -> 'QSGTexture': ...
...
class QSGGeometry(sip.wrapper):
    ...
    class Attribute(sip.simplewrapper):
        ...
        @staticmethod
        def createWithAttributeType(pos: int, tupleSize: int, primitiveType: int,
                                    attributeType: 'QSGGeometry.AttributeType') -> 'QSGGeometry.Attribute': ...
    ...
    def __init__(self, attribs: 'QSGGeometry.AttributeSet', vertexCount: int, indexCount: int = ...,
                 indexType: int = ...) -> None: ...
...
class QSGImageNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QSGImageNode.TextureCoordinatesTransformMode', 'QSGImageNode.TextureCoordinatesTransformFlag']) -> None: ...
    ...
    @staticmethod
    def rebuildGeometry(g: QSGGeometry, texture: 'QSGTexture', rect: QtCore.QRectF, sourceRect: QtCore.QRectF,
    ...
    def setTextureCoordinatesTransform(self, mode: typing.Union[
        'QSGImageNode.TextureCoordinatesTransformMode', 'QSGImageNode.TextureCoordinatesTransformFlag']) -> None: ...
...
class QSGMaterialShader(sip.wrapper):
    class RenderState(sip.simplewrapper):
        ...
        class DirtyStates(sip.simplewrapper):
            ...
            @typing.overload
            def __init__(self, f: typing.Union[
                'QSGMaterialShader.RenderState.DirtyStates', 'QSGMaterialShader.RenderState.DirtyState']) -> None: ...
    ...
    def setShaderSourceFiles(self,
                             type: typing.Union[QtGui.QOpenGLShader.ShaderType, QtGui.QOpenGLShader.ShaderTypeBit],
                             sourceFiles: typing.Iterable[str]) -> None: ...

    def setShaderSourceFile(self, type: typing.Union[QtGui.QOpenGLShader.ShaderType, QtGui.QOpenGLShader.ShaderTypeBit],
                            sourceFile: str) -> None: ...
    ...
    def updateState(self, state: 'QSGMaterialShader.RenderState', newMaterial: QSGMaterial,
...
class QSGMaterialRhiShader(QSGMaterialShader):
    ...
    class GraphicsPipelineState(sip.simplewrapper):
        ...
        class ColorMask(sip.simplewrapper):
            ...
            @typing.overload
            def __init__(self, f: typing.Union[
                'QSGMaterialRhiShader.GraphicsPipelineState.ColorMask', 'QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent']) -> None: ...
    ...
    def setFlag(self, flags: typing.Union['QSGMaterialRhiShader.Flags', 'QSGMaterialRhiShader.Flag'],
                on: bool = ...) -> None: ...

    def flags(self) -> 'QSGMaterialRhiShader.Flags': ...

    def updateGraphicsPipelineState(self, state: 'QSGMaterialRhiShader.RenderState',
                                    ps: 'QSGMaterialRhiShader.GraphicsPipelineState', newMaterial: QSGMaterial,
                                    oldMaterial: QSGMaterial) -> bool: ...

    def updateSampledImage(self, state: 'QSGMaterialRhiShader.RenderState', binding: int, newMaterial: QSGMaterial,
                           oldMaterial: QSGMaterial) -> 'QSGTexture': ...

    def updateUniformData(self, state: 'QSGMaterialRhiShader.RenderState', newMaterial: QSGMaterial,
                          oldMaterial: QSGMaterial) -> bool: ...
...
class QSGRendererInterface(sip.simplewrapper):
    ...
    class ShaderCompilationTypes(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QSGRendererInterface.ShaderCompilationTypes', 'QSGRendererInterface.ShaderCompilationType']) -> None: ...
    ...
    class ShaderSourceTypes(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QSGRendererInterface.ShaderSourceTypes', 'QSGRendererInterface.ShaderSourceType']) -> None: ...
...
class QSGSimpleTextureNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QSGSimpleTextureNode.TextureCoordinatesTransformMode', 'QSGSimpleTextureNode.TextureCoordinatesTransformFlag']) -> None: ...
