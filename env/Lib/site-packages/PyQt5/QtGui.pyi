...
class QPainter(sip.simplewrapper):
    ...
    @typing.overload
    def drawImage(self, targetRect: QtCore.QRect, image: QImage, sourceRect: QtCore.QRect,
                  flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...) -> None: ...
    ...
    @typing.overload
    def drawImage(self, p: QtCore.QPoint, image: QImage, sr: QtCore.QRect,
                  flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...) -> None: ...
    ...
    @typing.overload
    def fillRect(self, x: int, y: int, w: int, h: int,
                 b: typing.Union[QColor, QtCore.Qt.GlobalColor, QGradient]) -> None: ...
...
class QPdfWriter(QtCore.QObject, QPagedPaintDevice):
    ...
    def addFileAttachment(self, fileName: str, data: typing.Union[QtCore.QByteArray, bytes, bytearray],
                          mimeType: str = ...) -> None: ...
