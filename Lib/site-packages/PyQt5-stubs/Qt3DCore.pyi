...
class Qt3DCore(sip.simplewrapper):
    ...
    class QSceneChange(sip.simplewrapper):
        ...
        def setDeliveryFlags(self, flags: typing.Union[
            'QSceneChange.DeliveryFlags', 'QSceneChange.DeliveryFlag']) -> None: ...
    ...
    class QTransform('QComponent'):
        ...
        @staticmethod
        def rotateFromAxes(xAxis: QtGui.QVector3D, yAxis: QtGui.QVector3D,
                           zAxis: QtGui.QVector3D) -> QtGui.QMatrix4x4: ...
        ...
        @typing.overload
        @staticmethod
        def fromAxesAndAngles(axis1: QtGui.QVector3D, angle1: float, axis2: QtGui.QVector3D,
                              angle2: float) -> QtGui.QQuaternion: ...

        @typing.overload
        @staticmethod
        def fromAxesAndAngles(axis1: QtGui.QVector3D, angle1: float, axis2: QtGui.QVector3D, angle2: float,
                              axis3: QtGui.QVector3D, angle3: float) -> QtGui.QQuaternion: ...
