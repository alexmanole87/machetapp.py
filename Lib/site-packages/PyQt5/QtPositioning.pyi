...
class QGeoAreaMonitorSource(QtCore.QObject):
    ...
    class AreaMonitorFeatures(sip.wrapper):
        ...
        def __init__(self, f: typing.Union[
            'QGeoAreaMonitorSource.AreaMonitorFeatures', 'QGeoAreaMonitorSource.AreaMonitorFeature']) -> None: ...
...
class QGeoPositionInfo(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, coordinate: QGeoCoordinate,
                 updateTime: typing.Union[QtCore.QDateTime, datetime.datetime]) -> None: ...
...
class QGeoPositionInfoSource(QtCore.QObject):
    ...
    class PositioningMethods(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QGeoPositionInfoSource.PositioningMethods', 'QGeoPositionInfoSource.PositioningMethod']) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def createSource(sourceName: str, parameters: typing.Dict[str, typing.Any],
                     parent: QtCore.QObject) -> 'QGeoPositionInfoSource': ...
    ...
    @typing.overload
    @staticmethod
    def createDefaultSource(parameters: typing.Dict[str, typing.Any],
                            parent: QtCore.QObject) -> 'QGeoPositionInfoSource': ...
    ...
    def setPreferredPositioningMethods(self, methods: typing.Union[
        'QGeoPositionInfoSource.PositioningMethods', 'QGeoPositionInfoSource.PositioningMethod']) -> None: ...
...
class QGeoSatelliteInfoSource(QtCore.QObject):
    ...
    @staticmethod
    def createSource(sourceName: str, parameters: typing.Dict[str, typing.Any],
                     parent: QtCore.QObject) -> 'QGeoSatelliteInfoSource': ...
...
class QNmeaPositionInfoSource(QGeoPositionInfoSource):
    ...
    def __init__(self, updateMode: 'QNmeaPositionInfoSource.UpdateMode',
