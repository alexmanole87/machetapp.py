...
class QNdefFilter(sip.simplewrapper):
    ...
    @typing.overload
    def appendRecord(self, typeNameFormat: 'QNdefRecord.TypeNameFormat',
                     type: typing.Union[QtCore.QByteArray, bytes, bytearray], min: int = ...,
                     max: int = ...) -> None: ...
...
class QNdefNfcSmartPosterRecord(QNdefRecord):
    ...
    @typing.overload
    def addIcon(self, type: typing.Union[QtCore.QByteArray, bytes, bytearray],
                data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...
...
class QNearFieldManager(QtCore.QObject):
    ...
    class TargetAccessModes(sip.simplewrapper):
        ...
        def __init__(self, f: typing.Union[
            'QNearFieldManager.TargetAccessModes', 'QNearFieldManager.TargetAccessMode']) -> None: ...
    ...
    @typing.overload
    def registerNdefMessageHandler(self, typeNameFormat: QNdefRecord.TypeNameFormat,
                                   type: typing.Union[QtCore.QByteArray, bytes, bytearray], slot: PYQT_SLOT) -> int: ...
    ...
    def setTargetAccessModes(self, accessModes: typing.Union[
        'QNearFieldManager.TargetAccessModes', 'QNearFieldManager.TargetAccessMode']) -> None: ...
...
class QNearFieldShareManager(QtCore.QObject):
    ...
    class ShareModes(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union[
            'QNearFieldShareManager.ShareModes', 'QNearFieldShareManager.ShareMode']) -> None: ...
    ...
    def shareModesChanged(self, modes: typing.Union[
        'QNearFieldShareManager.ShareModes', 'QNearFieldShareManager.ShareMode']) -> None: ...
...
class QNearFieldTarget(QtCore.QObject):
    ...
    class AccessMethods(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(self,
                     f: typing.Union['QNearFieldTarget.AccessMethods', 'QNearFieldTarget.AccessMethod']) -> None: ...
    ...
    def handleResponse(self, id: 'QNearFieldTarget.RequestId',
                       response: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> bool: ...

    def setResponseForRequest(self, id: 'QNearFieldTarget.RequestId', response: typing.Any,
                              emitRequestCompleted: bool = ...) -> None: ...
    ...
    def sendCommands(self, commands: typing.Iterable[
        typing.Union[QtCore.QByteArray, bytes, bytearray]]) -> 'QNearFieldTarget.RequestId': ...

    def sendCommand(self,
                    command: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> 'QNearFieldTarget.RequestId': ...
