...
class QAbstractMessageHandler(QtCore.QObject):
    ...
    def handleMessage(self, type: QtCore.QtMsgType, description: str, identifier: QtCore.QUrl,
                      sourceLocation: 'QSourceLocation') -> None: ...

    def message(self, type: QtCore.QtMsgType, description: str, identifier: QtCore.QUrl = ...,
                sourceLocation: 'QSourceLocation' = ...) -> None: ...
...
class QAbstractXmlNodeModel(sip.simplewrapper):
    ...
    def nextFromSimpleAxis(self, axis: 'QAbstractXmlNodeModel.SimpleAxis',
                           origin: QXmlNodeModelIndex) -> QXmlNodeModelIndex: ...
...
class QXmlName(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, namePool: 'QXmlNamePool', localName: str, namespaceUri: str = ...,
                 prefix: str = ...) -> None: ...
...
class QXmlSchemaValidator(sip.simplewrapper):
    ...
    @typing.overload
    def validate(self, data: typing.Union[QtCore.QByteArray, bytes, bytearray],
                 documentUri: QtCore.QUrl = ...) -> bool: ...
